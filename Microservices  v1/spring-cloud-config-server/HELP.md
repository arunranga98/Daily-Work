...
* The original package name 'com.cts.microservices.spring-cloud-config-server' is invalid and this project uses 'com.cts.microservices.springcloudconfigserver' instead.
